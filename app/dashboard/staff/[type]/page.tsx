        ...
        <div className="min-h-screen bg-paper-white text-text-dark p-8 font-sans">
            <div className="max-w-6xl mx-auto">
                <div className="flex items-center gap-6 mb-12">
                    ...
                    <div>
                        <h1 className="text-5xl font-serif font-bold text-ruby-red capitalize tracking-tight mb-2">{type} Staff</h1>
                        <p className="text-text-muted font-serif italic text-lg opacity-80">Manage your team details and access permissions.</p>
                    </div>
                </div>
